...
param(
    ...
    [string]$ServiceName = "ThreeBooks.BookBackend.Api",

    [string]$DisplayName = "ThreeBooks BookBackend Api",

    [string]$PublishDirectory,

    [string]$ExecutableName = "ThreeBooks.BookBackend.Api.exe",
...
function Install-ServiceRegistration {
    ...
    $runtimeConfigPath = Join-Path -Path $Directory -ChildPath "ThreeBooks.BookBackend.Api.runtimeconfig.json"
    ...
    Invoke-Sc -Arguments @("description", $Name, "Local deployment for ThreeBooks BookBackend Api.")
